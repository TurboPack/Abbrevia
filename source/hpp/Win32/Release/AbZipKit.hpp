...
// (DO NOT EDIT: machine generated header) 'AbZipKit.pas' rev: 33.00 (Windows)
...
public:
	...
	__fastcall virtual ~TAbCustomZipKit();
...
public:
	...
	/* TAbCustomZipKit.Destroy */ inline __fastcall virtual ~TAbZipKit() { }
