...
typedef BOOL __cdecl (*TFDIIsCabinet)(void * hfdi, NativeInt hf, PFDICabInfo pfdici);
...
extern DELPHI_PACKAGE BOOL __fastcall FDIIsCabinet(void * hfdi, NativeInt hf, PFDICabInfo pfdici);
