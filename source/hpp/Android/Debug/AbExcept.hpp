...
// (DO NOT EDIT: machine generated header) 'AbExcept.pas' rev: 30.00 (Android)
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbArchiveBusy(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbArchiveBusy(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbBadStream(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbBadStream(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbDuplicateName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbDuplicateName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFileNotFound(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFileNotFound(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbNoArchive(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbNoArchive(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbUserAbort(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbUserAbort(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbNoSuchDirectory(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbNoSuchDirectory(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbUnhandledType(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbUnhandledType(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbSpanningNotSupported(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbSpanningNotSupported(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbInvalidSpanningThreshold(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbInvalidSpanningThreshold(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbCabException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbCabException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbTarException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbTarException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbGzipException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbGzipException(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipBadSpanStream(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipBadSpanStream(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipBadCRC(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipBadCRC(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInflateBlock(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInflateBlock(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInvalid(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInvalid(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbInvalidIndex(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbInvalidIndex(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInvalidFactor(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInvalidFactor(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInvalidLFH(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInvalidLFH(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInvalidMethod(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInvalidMethod(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInvalidPassword(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInvalidPassword(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipInvalidStub(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipInvalidStub(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipNoExtraction(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipNoExtraction(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipNoInsertion(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipNoInsertion(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipSpanOverwrite(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipSpanOverwrite(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipStreamFull(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipStreamFull(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipTruncate(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipTruncate(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipUnsupported(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipUnsupported(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbZipVersion(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbZipVersion(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbReadError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbReadError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbGzipBadCRC(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbGzipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbGzipBadCRC(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbGzipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbGzipBadFileSize(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbGzipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbGzipBadFileSize(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbGzipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbGzipInvalid(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbGzipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbGzipInvalid(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbGzipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbTarInvalid(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbTarException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbTarInvalid(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbTarException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbTarBadFileName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbTarException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbTarBadFileName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbTarException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbTarBadLinkName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbTarException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbTarBadLinkName(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbTarException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbTarBadOp(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbTarException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbTarBadOp(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbTarException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbVMSInvalidOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbVMSInvalidOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbVMSErrorOpenSwap(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbVMSErrorOpenSwap(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbVMSSeekFail(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbVMSSeekFail(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbVMSReadFail(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbVMSReadFail(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbVMSWriteFail(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbVMSWriteFail(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbVMSWriteTooManyBytes(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbVMSWriteTooManyBytes(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbBBSReadTooManyBytes(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbBBSReadTooManyBytes(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbBBSSeekOutsideBuffer(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbBBSSeekOutsideBuffer(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbBBSInvalidOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbBBSInvalidOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbBBSWriteTooManyBytes(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbBBSWriteTooManyBytes(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbSWSNotEndofStream(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbSWSNotEndofStream(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbSWSSeekFailed(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbSWSSeekFailed(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbSWSWriteFailed(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbSWSWriteFailed(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbSWSInvalidOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbSWSInvalidOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbSWSInvalidNewOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbZipException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbSWSInvalidNewOrigin(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbZipException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbNoCabinetDll(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbNoCabinetDll(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFileOpenError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFileOpenError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFileReadError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFileReadError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFileWriteError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFileWriteError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFileCloseError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFileCloseError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFileSeekError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFileSeekError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFileDeleteError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFileDeleteError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIAddFileError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIAddFileError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCICreateError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCICreateError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFlushCabinetError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFlushCabinetError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFCIFlushFolderError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFCIFlushFolderError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFDICopyError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFDICopyError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFDICreateError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFDICreateError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbInvalidCabTemplate(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbInvalidCabTemplate(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbInvalidCabFile(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbCabException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbInvalidCabFile(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbCabException(ResStringRec, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateResFmt */ inline __fastcall EAbFileTooLarge(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : EAbException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EAbFileTooLarge(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : EAbException(ResStringRec, Args, Args_High, AHelpContext) { }
