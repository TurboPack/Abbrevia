...
begin
  ...
  for i := 0 to 15 do begin
    ...
    FShortDistSymbols[Dist] := AbToUInt8(i);
  end;
  Value := -1;
  for i := 0 to 255 do begin
    if (Value < FShortDistSymbols[i]) then
      ...
      FShortDistSymbols[i] := AbToUInt8(Value);
  end;
  ...
  for i := 16 to 29 do begin
    ...
    FMediumDistSymbols[Dist] := AbToUInt8(i);
  end;
  Value := -1;
  for i := 0 to 255 do begin
    if (Value < FMediumDistSymbols[i]) then
      ...
      FMediumDistSymbols[i] := AbToUInt8(Value);
  end;
